...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://raw.githubusercontent.com/wartw/dnsmasq_sniproxy_install/master/dnsmasq.conf
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/wartw/dnsmasq_sniproxy_install/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        ...
        download /etc/default/sniproxy https://raw.githubusercontent.com/wartw/dnsmasq_sniproxy_install/master/sniproxy.default
    fi
    ...
    download /etc/sniproxy.conf https://raw.githubusercontent.com/wartw/dnsmasq_sniproxy_install/master/sniproxy.conf
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/wartw/dnsmasq_sniproxy_install/master/proxy-domains.txt
